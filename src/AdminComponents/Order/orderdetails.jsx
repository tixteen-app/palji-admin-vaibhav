...
//     try {
//       setLoading(true);
//       const t =await makeApi(`/api/shiprocket/create-shipment/${id}`, "POST");
//       console.log(t)
//       // setOrder((prev) => ({ ...prev, status: "Canceled" }));
...
//               <div className="new_add_cat_modal">
//                 <h2>Confirm Ship </h2>
//                 <p>Are you sure you want to Ship this shipment?</p>
//                 <div className="new_add_cat_modal-actions">
//                   <button className="new_add_cat_modal-deleteBtn" onClick={confirmShip}>Confirm Cancel</button>
//                   <button className="new_add_cat_modal-cancelBtn" onClick={() => setShowPopupforship(false)}>Cancel</button>
//                 </div>
//               </div>
//             </div>
//           )}
...
//     } else if (countdownforship === 0 && !undo) {
//       shipOrder();
...
//     try {
//       setLoading(true);
//       console.log(orderData?.pickup_address?.pin_code, order?.shippingAddress?.pincode);
...
//         weight: shipments.weight, // Weight of the shipment
...
//       setCourierServiceability(response?.data?.data?.available_courier_companies || []);
//     } catch (error) {
...
//             <div className="new_add_cat_modal-overlay">
//               <div className="new_add_cat_modal">
//                 <h2>Select Courier Partner</h2>
//                 <div className="courier-list">
//                   {courierServiceability.map((courier, index) => (
//                     <div key={index} className="courier-item">
//                       <p><strong>Courier:</strong> {courier.courier_name}</p>
//                       <p><strong>Price:</strong> ₹{courier.rate}</p>
//                       <p><strong>Estimated Delivery:</strong> {courier.etd}</p>
//                       <button onClick={() => setSelectedCourier(courier.courier_id)}>Select</button>
//                     </div>
//                   ))}
//                 </div>
//                 <div className="new_add_cat_modal-actions">
//                   <button className="new_add_cat_modal-deleteBtn" onClick={confirmShip}>Confirm Ship</button>
//                   <button className="new_add_cat_modal-cancelBtn" onClick={() => setShowPopupforship(false)}>Cancel</button>
//                 </div>
//               </div>
//             </div>
